    ...
    return <div className="login">
      <div className="row">
        <div className="col-xs-12 col-sm-6 col-md-4">
          ...
          <Alert type="info">
            Clients could log in by just entering their credentials below. Administrators have specific e-mails and passwords that only they know in order to log in. To register as an administator, please write an e-mail to 4025832@live.napier.ac.uk asking for admin access, and the developers of the app will be in touch with you soon.
          </Alert>
